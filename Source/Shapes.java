...
public class Shapes {
    private StandardPen p;

    /**
     * Constructs a new Shapes object
     * @return a new Shapes Object
     */
    public Shapes(){
        this(200, 200);
    }
     ...
     * @param width the width of the SketchPad
     * @param height the height of the SketchPad
     * @return a new Shapes object
     */
    ...
    /**
     * Sets the width of the pen used to draw a shape
